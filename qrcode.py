...
# ===============================Header===============================
        ...
        bu0=Button(bg1,image=self.but0,command=self.G,cursor="hand2")
        bu0.place(x=300,y=100,width=200,height=200)
        
        bu0_1=Button(bg1,text="Generate Qr",command=self.G,cursor="hand2",font=("times new roman",10,"bold"),bg="blue",fg="white")
        ...
        bu1=Button(bg1,image=self.but1,command=self.S,cursor="hand2")
        bu1.place(x=700,y=100,width=200,height=200)
        
        bu1_1=Button(bg1,text="SCAN QR CODE",command=self.S,cursor="hand2",font=("times new roman",10,"bold"),bg="blue",fg="white")
